        ...
        : IDataStore<YardItem>
    {
        ...
        public YardItemDataStore()
        {
            _items = new List<YardItem>()
            {
                ...
                new YardItem(Guid.Parse("58de5eac-5d74-49d8-91b0-3fb148c58b39"), 'B', 2) { BoatClass = BoatClass.Laser, Owner = "Rob Jones", DueDate = DateTime.Now.AddDays(1) },
                new YardItem('C', 2) { BoatClass = BoatClass.GP14, Owner = "Paul Jones", DueDate = DateTime.Now.AddDays(1) },
                new YardItem('D', 2) { BoatClass = BoatClass.Falcon, Owner = "Jeff Jones", DueDate = DateTime.Now.AddDays(1) },
                new YardItem('E', 2) { BoatClass = BoatClass.GP14, Owner = "Obi Wan Jones", DueDate = DateTime.Now.AddDays(1) },
